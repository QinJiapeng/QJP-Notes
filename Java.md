...
* 一个数组内存图
  ...
  ![](https://img.jiapeng.store/img/202307081655954.png)

* 两个数组内存图

  ![](https://img.jiapeng.store/img/202307081655956.png)

* 多个数组指向相同内存图

  ![](https://img.jiapeng.store/img/202307081655957.png)
...
![](https://img.jiapeng.store/img/202307081655958.png)

<img src="https://img.jiapeng.store/img/202307081655959.png" alt="Debug条件断点" style="zoom:50%;" />
...
* Shallow Clone & Deep Clone：
  ...
  * 如果对一个引用类型进行克隆时只是克隆了它的引用，和原始对象共享对象成员变量
  ...
  ![](https://img.jiapeng.store/img/202307081655960.jpg)
...
* 对象 4：new String("b")、对象 5：常量池中的 b
  <img src="https://img.jiapeng.store/img/202307081655962.png" style="zoom:67%;" />
...
![](https://img.jiapeng.store/img/202307081655963.png)
...
![](https://img.jiapeng.store/img/202307081655964.png)
...
![](https://img.jiapeng.store/img/202307081655965.png)
...
* Set 系列集合元素无序的根本原因
  ...
  * JDK 1.8 之后：哈希表 = 数组（初始容量16) + 链表 + 红黑树  + （哈希算法）
  ...
  ![](https://img.jiapeng.store/img/202307081655966.png)
...
* JDK1.8 以后 HashMap 由**数组+链表 +红黑树**数据结构组成
  ...
  * 即使哈希函数取得再好，也很难达到元素百分百均匀分布。当 HashMap 中有大量的元素都存放到同一个桶中时，就相当于一个长的单链表，假如单链表有 n 个元素，遍历的**时间复杂度是 O(n)**，所以 JDK1.8 中引入了 红黑树（查找**时间复杂度为 O(logn)**）来优化这个问题，使得查找效率更高
  ...
  ![](https://img.jiapeng.store/img/202307081655967.png)
...
![](https://img.jiapeng.store/img/202307081655968.bmp)
...
* put()：jdk1.8 前是头插法 (链地址法)，多线程下扩容出现循环链表，jdk1.8 以后引入红黑树，插入方法变成尾插法
  ...
  ```
    ...
    * `(n - 1) & hash`：计算下标位置
    ...
    <img src="https://img.jiapeng.store/img/202307081655969.png" style="zoom: 67%;" />
...
* resize()：
  ...
  ![](https://img.jiapeng.store/img/202307081655970.png)
