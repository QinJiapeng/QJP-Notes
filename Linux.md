...
<img src="https://img.jiapeng.store/img/202307081712468.png" style="zoom:80%;" />

移动设备操作系统：

![](https://img.jiapeng.store/img/202307081712469.png)
...
![Linux](https://img.jiapeng.store/img/202307081712470.png)
...
![Linux文件系统](https://img.jiapeng.store/img/202307081712471.png)
...
首先设置虚拟机中 NAT 模式的选项，打开 VMware，点击编辑下的虚拟网络编辑器，设置 NAT 参数
	![](https://img.jiapeng.store/img/202307081712472.jpg)

**注意**：VMware Network Adapter VMnet8 保证是启用状态

​	![](https://img.jiapeng.store/img/202307081712473.jpg)
...
* 在虚拟机中访问网络，需要增加一块 NAT 网卡
  * 【虚拟机】--【设置】--【添加】
  * <img src="https://img.jiapeng.store/img/202307081712474.jpg" style="zoom:80%;" />
...
![](https://img.jiapeng.store/img/202307081712475.png)
...
![](https://img.jiapeng.store/img/202307081712476.png)
...
![](https://img.jiapeng.store/img/202307081712477.png)
...
<img src="https://img.jiapeng.store/img/202307081712478.png" style="zoom: 50%;" />
...
![](https://img.jiapeng.store/img/202307081712479.png)
...
<img src="https://img.jiapeng.store/img/202307081712480.png" style="zoom: 67%;" />
...
![](https://img.jiapeng.store/img/202307081712481.png)
...
* 下次再使用 vim 编辑文件时，会看到以下屏幕信息：
  ...
  ![](https://img.jiapeng.store/img/202307081712482.png)
...
<img src="https://img.jiapeng.store/img/202307081712483.png" style="zoom: 80%;" />
...
* `ifconfig`：显示激活的网卡信息  ens
  <img src="https://img.jiapeng.store/img/202307081712484.png"  />
...
* `ping -c 2 www.baidu.com`
  ![](https://img.jiapeng.store/img/202307081712485.png)
...
* `lsblk`：以树状列出所有块设备
  ![](https://img.jiapeng.store/img/202307081712486.png)
...
* `lsblk -f`：不会列出所有空设备
  ![](https://img.jiapeng.store/img/202307081712487.png)
...
![](https://img.jiapeng.store/img/202307081712488.png)
...
* 开始挂载
  ...
  ![挂载成功](https://img.jiapeng.store/img/202307081712489.png)
...
![](https://img.jiapeng.store/img/202307081712490.png)
