...
![image-20221214153932466](https://img.jiapeng.store/img/202307081644059.png)
...
<img src="https://img.jiapeng.store/img/202307081644061.png" alt="image-20221214144229379" style="zoom:67%;" />
...
* 普通对象
  ...
  ![image-20221215152931044](https://img.jiapeng.store/img/202307081644062.png)

- 数组对象

  ![image-20221215153001246](https://img.jiapeng.store/img/202307081644063.png)

- Mark Word 结构：最后两位是**锁标志位**

  ![image-20221215153346176](https://img.jiapeng.store/img/202307081644064.png)

Monitor结构如下

![image-20221215153549073](https://img.jiapeng.store/img/202307081644065.png)
...
- 当 Thread-2 执行 synchronized(obj) 就会将 Monitor 的所有者 Owner 置为 Thread-2，Monitor 中只能有一个 Owner，**obj 对象的 Mark Word 指向 Monitor**，把**对象原有的 MarkWord 存入线程栈中的锁记录**中（轻量级锁部分详解）
  ...
  ![image-20221215155940004](https://img.jiapeng.store/img/202307081644066.png)
...
![image-20221215165232482](https://img.jiapeng.store/img/202307081644067.png)
...
![image-20221215183114971](https://img.jiapeng.store/img/202307081644068.png)

- 让锁记录中 Object reference 指向锁住的对象，并尝试用 CAS 替换 Object 的 Mark Word，将 Mark Word 的值存入锁记录
- 如果 CAS 替换成功，对象头中存储了锁记录地址和状态 00（轻量级锁） ，表示由该线程给对象加锁

![image-20221215183714102](https://img.jiapeng.store/img/202307081644069.png)
...
![image-20221215185242362](https://img.jiapeng.store/img/202307081644070.png)

当退出 synchronized 代码块（解锁时）

- 如果有取值为 null 的锁记录，表示有重入，这时重置锁记录，表示重入计数减 1

![image-20221215185444027](https://img.jiapeng.store/img/202307081644071.png)
...
![image-20221215212631976](https://img.jiapeng.store/img/202307081644072.png)

* Thread-1 加轻量级锁失败，进入锁膨胀流程：为 Object 对象申请 Monitor 锁，**通过 Object 对象头获取到持锁线程**，将 Monitor 的 Owner 置为 Thread-0，将 Object 的对象头指向重量级锁地址，然后自己进入 Monitor 的 EntryList BLOCKED

![image-20221215213407273](https://img.jiapeng.store/img/202307081644073.png)
...
![image-20221215214035935](https://img.jiapeng.store/img/202307081644074.png)

* 自旋失败的情况：

![image-20221215215018207](https://img.jiapeng.store/img/202307081644075.png)
...
<img src="https://img.jiapeng.store/img/202307081644076.png" alt="image-20221215215623412" style="zoom:60%;" />

<img src="https://img.jiapeng.store/img/202307081644077.png" alt="image-20221215215806415" style="zoom:60%;" />
...
![image-20221215215856558](https://img.jiapeng.store/img/202307081644078.png)
...
![image-20221217143514287](https://img.jiapeng.store/img/202307081644079.png)
...
![image-20221217202630060](https://img.jiapeng.store/img/202307081644080.png)
...
![image-20221217202813772](https://img.jiapeng.store/img/202307081644081.png)
...
![image-20221217203116495](https://img.jiapeng.store/img/202307081644082.png)
...
![image-20221217203234588](https://img.jiapeng.store/img/202307081644084.png)
...
<img src="https://img.jiapeng.store/img/202307081644085.png" alt="image-20221217205301303" style="zoom:50%;" />
...
<img src="https://img.jiapeng.store/img/202307081644086.png" alt="image-20221217205327400" style="zoom:80%;" />
...
<img src="https://img.jiapeng.store/img/202307081644087.png" alt="image-20221217213134900" style="zoom:50%;" />
...
![image-20221218161331698](https://img.jiapeng.store/img/202307081644088.png)
...
![image-20221218161408132](https://img.jiapeng.store/img/202307081644089.png)
...
![image-20221218161426114](https://img.jiapeng.store/img/202307081644090.png)
...
![image-20221218162855956](https://img.jiapeng.store/img/202307081644091.png)
...
![image-20221218162929625](https://img.jiapeng.store/img/202307081644092.png)
...
![image-20221219124713678](https://img.jiapeng.store/img/202307081644093.png)
...
![image-20221220150457539](https://img.jiapeng.store/img/202307081644094.png)

@sun.misc.Contended：防止缓存行伪共享，在使用此注解的对象或字段的前后各增加 128 字节大小的 padding，使用 2 倍于大多数硬件缓存行让 CPU 将对象预读至缓存时**占用不同的缓存行**，这样就不会造成对方缓存行的失效

![image-20221220150512244](https://img.jiapeng.store/img/202307081644095.png)
...
<img src="https://img.jiapeng.store/img/202307081644096.png" alt="image-20221220203052649" style="zoom:50%;" />
...
<img src="https://img.jiapeng.store/img/202307081644097.png" alt="image-20221220203225525" style="zoom:50%;" />
...
![image-20221220205501388](https://img.jiapeng.store/img/202307081644098.png)
...
<img src="https://img.jiapeng.store/img/202307081644099.png" alt="image-20221220205553576" style="zoom:33%;" />

<img src="https://img.jiapeng.store/img/202307081644100.png" alt="image-20221220205617101" style="zoom:33%;" />
...
<img src="https://img.jiapeng.store/img/202307081644101.png" alt="image-20221220205706874" style="zoom:50%;" />
...
<img src="https://img.jiapeng.store/img/202307081644102.png" alt="image-20221220205727143" style="zoom:50%;" />
...
![image-20221221143241372](https://img.jiapeng.store/img/202307081644103.png)
...
![image-20221221143402376](https://img.jiapeng.store/img/202307081644104.png)

* `h.next = h` → `head = first`

![image-20221221144624353](https://img.jiapeng.store/img/202307081644105.png)
...
![image-20221221151417066](https://img.jiapeng.store/img/202307081644106.png)
...
![image-20221221151442255](https://img.jiapeng.store/img/202307081644107.png)
...
![image-20221221151520220](https://img.jiapeng.store/img/202307081644108.png)
...
![image-20230123102429998](https://img.jiapeng.store/img/202307081644109.png)
...
<img src="https://img.jiapeng.store/img/202307081644110.png" alt="image-20230123161608936" style="zoom:67%;" />
...
<img src="https://img.jiapeng.store/img/202307081644111.png" alt="image-20230124222033380" style="zoom:50%;" />
...
<img src="https://img.jiapeng.store/img/202307081644112.png" alt="image-20230124222100606" style="zoom:50%;" />
...
<img src="https://img.jiapeng.store/img/202307081644113.png" alt="image-20230124222126235" style="zoom:50%;" />
...
![image-20230124222159028](https://img.jiapeng.store/img/202307081644114.png)
...
![image-20230124222209989](https://img.jiapeng.store/img/202307081644115.png)
...
![image-20230124222329697](https://img.jiapeng.store/img/202307081644116.png)
...
![image-20230124222355299](https://img.jiapeng.store/img/202307081644117.png)
...
![image-20230124222408888](https://img.jiapeng.store/img/202307081644118.png)
...
![image-20230124222521959](https://img.jiapeng.store/img/202307081644119.png)
...
- 获取读锁失败，进入 sync.doAcquireShared(1) 流程开始阻塞，首先也是调用 addWaiter 添加节点，不同之处在于节点被设置为 Node.SHARED 模式而非 Node.EXCLUSIVE 模式，注意此时 t2 仍处于活跃状态
  ...
  ![image-20230124222541456](https://img.jiapeng.store/img/202307081644120.png)

  

- 这种状态下，假设又有 t3 r.lock，t4 w.lock，这期间 t1 仍然持有锁，就变成了下面的样子

  ![image-20230124222630983](https://img.jiapeng.store/img/202307081644121.png)
...
![image-20230124222647697](https://img.jiapeng.store/img/202307081644122.png)
...
![image-20230124222716127](https://img.jiapeng.store/img/202307081644123.png)
...
![image-20230124222749688](https://img.jiapeng.store/img/202307081644124.png)
...
![image-20230124222811232](https://img.jiapeng.store/img/202307081644125.png)
...
![image-20230124222830608](https://img.jiapeng.store/img/202307081644126.png)
...
- transfer()：数据转移到新表中，完成扩容
  ...
  ![image-20230124222859272](https://img.jiapeng.store/img/202307081644127.png)
...
- 缺点：Segments 数组默认大小为16，这个容量初始化指定后就不能改变了，并且不是懒惰初始化
  ...
  ![](https://img.jiapeng.store/img/202307081644128.png)
...
![image-20230124222923499](https://img.jiapeng.store/img/202307081644129.png)
...
![image-20230124222939061](https://img.jiapeng.store/img/202307081644130.png)
...
![image-20230124222956545](https://img.jiapeng.store/img/202307081644131.png)
...
![image-20230124223036631](https://img.jiapeng.store/img/202307081644132.png)
...
![image-20230124223102118](https://img.jiapeng.store/img/202307081644133.png)

![image-20230124223112477](https://img.jiapeng.store/img/202307081644134.png)

![image-20230124223122384](https://img.jiapeng.store/img/202307081644135.png)
...
![image-20230124223139969](https://img.jiapeng.store/img/202307081644136.png)

![image-20230124223146817](https://img.jiapeng.store/img/202307081644137.png)

![image-20230124223153416](https://img.jiapeng.store/img/202307081644138.png)
